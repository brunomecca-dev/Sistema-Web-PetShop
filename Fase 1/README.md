...
- **Catálogo de Produtos (`produtos.html`):** Divisão clara usando títulos e artigos para as categorias _Cães_, _Gatos_ e _Pequenos Pets_. Cada produto possui marcação para foto (`<img>`), descrição contextual e preço destacado.
...
- **Acesso ao Sistema (GitHub Pages):** https://brunomecca-dev.github.io/Sistema-Web-PetShop/Fase%201/index.html
